...
import com.trailblazing.shoppinglisttesting.launchFragmentInHiltContainer
import com.trailblazing.shoppinglisttesting.repositories.FakeShoppingRepositoryAndroidTest
...
class AddShoppingItemFragmentTest {
    ...
    @Test
    fun onPressBackButton_popBackStack() {
    ...
    @Test
    fun onClickAddImageOfItem_navigateToImagePickFragment() {
        val navController = mock(NavController::class.java)
        launchFragmentInHiltContainer<AddShoppingItemFragment> {
            Navigation.setViewNavController(requireView(), navController)
        }
